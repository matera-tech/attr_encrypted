...
class AttrEncryptedTest < Minitest::Test
  ...
  def test_should_encrypt_email
    refute_nil User.legacy_encrypt_email('test@example.com', iv: @iv)
    refute_equal 'test@example.com', User.legacy_encrypt_email('test@example.com', iv: @iv)
  end
  ...
  def test_should_encrypt_email_when_modifying_the_attr_writer
    ...
    assert_equal User.legacy_encrypt_email('test@example.com', iv: iv, salt: salt), @user.encrypted_email
  end
  ...
  def test_should_decrypt_email
    encrypted_email = User.legacy_encrypt_email('test@example.com', iv: @iv)
    refute_equal 'test@test.com', encrypted_email
    assert_equal 'test@example.com', User.legacy_decrypt_email(encrypted_email, iv: @iv)
  end
  ...
  def test_should_decrypt_email_when_reading
    ...
    @user.encrypted_email = User.legacy_encrypt_email('test@example.com', iv: iv, salt: salt)
